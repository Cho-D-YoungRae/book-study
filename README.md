...
- [자바/스프링 개발자를 위한 실용주의 프로그래밍 - 김우근](./books/자바%20스프링%20개발자를%20위한%20실용주의%20프로그래밍/)
- [도메인 주도 설계 첫걸음](./books/도메인%20주도%20설계%20첫걸음/)
- [이벤트 소싱과 마이크로서비스 아키텍처](./books/이벤트%20소싱과%20마이크로서비스%20아키텍처/)
...
- [RAG 마스터: 랭체인으로 완성하는 LLM 서비스](./books/RAG%20마스터%20랭체인으로%20완성하는%20LLM%20서비스/)
- [밑바닥부터 만들면서 배우는 LLM](./books/밑바닥부터%20만들면서%20배우는%20LLM/)
- [이것이 Spring AI다](./books/이것이%20Spring%20AI다/)
- [이론부터 실전까지 AI 에이전트 완벽 마스터](./books/이론부터%20실전까지%20AI%20에이전트%20완벽%20마스터/)
- [한 권으로 끝내는 LLM 실전 파인튜닝](./books/한%20권으로%20끝내는%20LLM%20실전%20파인튜닝/)
- [가상 면접 사례로 배우는 생성형 AI 서비스 설계](./books/가상%20면접%20사례로%20배우는%20생성형%20AI%20서비스%20설계/README.md)
